...
public class MockVirtualFlowScrollTests extends ApplicationTest {
    ...
    public void testScroll1() {
        ...
        assertEqualsRange(cvb, NumberRange.of(0, 5));
    }
    ...
    public void testScroll4() {
        ...
        assertEqualsRange(cvb, NumberRange.of(2, 9));
    }
    ...
    public void testScroll5() {
        ...
        assertEqualsRange(cvb, NumberRange.of(2, 8));
    }
